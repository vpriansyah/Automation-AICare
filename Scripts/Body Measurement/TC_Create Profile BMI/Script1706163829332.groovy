...
Mobile.tap(findTestObject('Object Repository/icon beranda'), 0)

Mobile.tap(findTestObject('Object Repository/tab BMI'), 0)

Mobile.tap(findTestObject('Object Repository/BMI Object/tab pilih profile BMI'), 0)
...
Mobile.setText(findTestObject('Object Repository/Create Profile Object/Nama Belakang Active'), 'BMI', 0)
