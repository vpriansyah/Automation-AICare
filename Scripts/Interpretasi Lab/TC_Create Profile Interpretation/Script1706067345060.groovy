...
Mobile.tap(findTestObject('Object Repository/Interpretation lab object/tab dropdown select profile'), 0)

'Klik Button buat profile'
...
Mobile.setText(findTestObject('Object Repository/Create Profile Object/Nama Belakang Active'), 'Interpretation Lab', 0)
